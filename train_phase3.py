...
from model import UNetWithOutcome3
import pandas as pd
...
from torchvision.transforms import functional as TF  # For Gaussian blur
...
def optimize_ablation_parameters(args):
    ...
    model = UNetWithOutcome3(in_channels=7, out_channels=3, num_views=args.num_views)
